...
<a href="/t/{thread.number}" class="flex items-start gap-4 px-4 py-3 transition hover:bg-gray-50 dark:hover:bg-gray-800/50">
{#if thread.author}
...
class="block rounded-lg border border-gray-200 bg-white p-4 shadow-sm transition hover:shadow-md dark:border-gray-800 dark:bg-gray-900">
